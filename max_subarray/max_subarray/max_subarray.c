...
void Max_Cross_Subarray(int *source,Max_Subarray_result *result,int low_index,int mid_index,int high_index);
void Max_Subarray(int *source,Max_Subarray_result *result,int low_index,int high_index);
...
void Max_Subarray2(int *source,Max_Subarray_result *result,int low_index,int high_index)
{
	int i;
	int max_sum,sum;
